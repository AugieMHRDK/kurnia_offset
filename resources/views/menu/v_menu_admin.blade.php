	...
	<div class="aside-menu flex-column-fluid pt-0 pb-7 py-lg-10" id="kt_aside_menu">
		...
		<div id="kt_aside_menu_wrapper" class="w-100 hover-scroll-overlay-y scroll-ps d-flex" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu" data-kt-scroll-offset="0">
			<div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-icon-gray-400 menu-arrow-gray-400 fw-bold fs-6" data-kt-menu="true">
				...
				<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-3">
					<a href="{{url('users')}}">
					<span class="menu-link menu-center" title="Pengguna" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right" data-bs-custom-class="tooltip-dark">
						<span class="menu-icon">
							<i class="fa fa-users" style="font-size:18pt"></i>
						</span>
					</span>
					</a>
				</div>
				<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-3">
					<a href="{{url('produk')}}">
					<span class="menu-link menu-center" title="Produk" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right" data-bs-custom-class="tooltip-dark">
						<span class="menu-icon">
							<i class="fa fa-cubes" style="font-size:18pt"></i>
						</span>
					</span>
					</a>
				</div>
				<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-3">
					<a href="{{url('tracking')}}">
					<span class="menu-link menu-center" title="Update Status Pesanan" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right" data-bs-custom-class="tooltip-dark">
						<span class="menu-icon">
							<i class="fa fa-pen" style="font-size:18pt"></i>
						</span>
					</span>
					</a>
				</div>
				<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-3">
					<a href="{{url('daftar-pesanan')}}">
					<span class="menu-link menu-center" title="Daftar Pesanan" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right" data-bs-custom-class="tooltip-dark">
						<span class="menu-icon">
							<i class="fa fa-clipboard " style="font-size:18pt"></i>
						</span>
					</span>
					</a>
				</div>
